...
************************************************************************/
    function testOGR_F_SetGetGeometry() {
        ...
        $this->assertFalse($iRetval, "Problem with OGR_F_SetGeometry() ".
                            "or OGR_F_GetGeometryRef(): ".
...
************************************************************************/
    ...
    function testOGR_F_Clone() {
        ...
        $this->assertFalse($iRetval, "Problem with OGR_F_Clone() : ".
                             "Files comparison did not matched.\n");
...
************************************************************************/
    ...
    function testOGR_F_GetFieldCount() {
        $iFID =2;
        $hF = OGR_L_GetFeature($this->hLayer, $iFID);

        $nFieldCount = OGR_F_GetFieldCount($hF);
        $expected = 9;
        $this->AssertEquals($expected, $nFieldCount, "Problem with ".
                           " OGR_F_GetFieldCount().");
        OGR_F_Destroy($hF);
    }
/***********************************************************************
...
************************************************************************/
    ...
    function testOGR_F_GetFieldDefnRef() {
        ...
        $this->assertFalse($iRetval, "Problem with OGR_F_GetFieldDefnRef() : ".
                             "Files comparison did not matched.\n");
