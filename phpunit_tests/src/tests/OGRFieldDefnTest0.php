...
class OGRFieldDefnTest0 extends TestCase
{
    ...
    public function testOGR_Fld_CreateDestroy()
    {
        $strFieldName = "name";
    ...
    public function testOGR_Fld_SetGetName()
    {
        $strFieldName = "name";
        $hFieldDefn = OGR_Fld_Create($strFieldName, OFTString);
    ...
    public function testOGR_Fld_SetGetType()
    {
        $strFieldName = "name";
        $hFieldDefn = OGR_Fld_Create($strFieldName, OFTString);
    ...
    public function testOGR_Fld_SetGetJustify()
    {
        $strFieldName = "name";
        $hFieldDefn = OGR_Fld_Create($strFieldName, OFTString);
    ...
    public function testOGR_Fld_SetGetWidth()
    {
        $strFieldName = "name";
        $hFieldDefn = OGR_Fld_Create($strFieldName, OFTString);
    ...
    public function testOGR_Fld_SetGetPrecision()
    {
        $strFieldName = "area";
    ...
    public function testOGR_Fld_Set()
    {
        $strFieldName = "area";
        $hFieldDefn = OGR_Fld_Create($strFieldName, OFTReal);
    ...
    public function testOGR_GetFieldTypeName()
    {
